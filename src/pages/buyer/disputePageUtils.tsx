...
export function formatDisputeDate(value: string | null) {
  if (!value) {
...
export function formatDisputeReason(value: string) {
  return value
    .toLowerCase()
    .split("_")
...
export function formatDisputeStatus(value: string) {
  return value
    .toLowerCase()
    .split("_")
    .map((part) => part.charAt(0).toUpperCase() + part.slice(1))
...
export function getDisputeImage(product?: Product) {
